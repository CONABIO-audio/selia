    ...
    def get_context_data(self, *args, **kwargs):
        return {
            **super().get_context_data(*args, **kwargs),
            ...
            "update_form_template": self.get_update_form_template(),
            "summary_template": self.get_summary_template(),
            "help_template": self.get_help_template(),
            "viewer_template": self.get_viewer_template(),
        }
