...
from irekua_collections.filters import collection_items
...
class ListCollectionItemsView(SeliaListView, SingleObjectMixin):
    ...
    filter_class = collection_items.Filter
    search_fields = collection_items.search_fields
    ordering_fields = collection_items.ordering_fields
    ...
    def get_initial_queryset(self):
        return CollectionItem.objects.filter(collection=self.object)
