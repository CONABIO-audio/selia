...
class DetailUserView(SeliaDetailView):
    ...
    def get_form_class(self):
        ...
        class Form(forms.ModelForm):
            institution_name = forms.CharField(
                max_length=256, label=_("Institution name"), required=False
            )
            institution_code = forms.CharField(
                max_length=64, label=_("Institution code"), required=False
            )
            ...
            country = forms.ChoiceField(
                choices=COUNTRIES, label=_("Country"), required=False
            )
            postal_code = forms.CharField(
                max_length=8, label=_("Postal code"), required=False
            )
            ...
            class Meta:
                ...
                widgets = {"institution": get_autocomplete_widget(model=Institution)}
    ...
    def form_valid(self, form):
        ...
        institution_data = {
            field: form.cleaned_data[field] for field in INSTITUTION_FIELDS
        }
