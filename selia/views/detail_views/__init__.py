from .collection_device import DetailCollectionDeviceView
from .collection_site import DetailCollectionSiteView
from .collection_user import DetailCollectionUserView
