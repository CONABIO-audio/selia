...
SUBJECT = _("Invitation to join Selia")
...
class CreateUserView(SeliaCreateView):
    template_name = "selia_user_home/create/users/create_form.html"
    success_url = "selia_user_home:home"
    ...
    def send_invitation_email(self, user):
        ...
        send_mail(SUBJECT, message, settings.EMAIL, [user.email], fail_silently=True)
